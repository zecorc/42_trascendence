...
import { JwtAuthGuard } from '../auth/auth.guard'; // Remove the import for AuthModule
...
@Module({
  ...
  providers: [UserService, PictureService, AuthService, JwtAuthGuard], // Include AuthService and JwtAuthGuard here
  exports: [UserService],
})
